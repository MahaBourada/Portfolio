...
import image from "../../img/arcade.png";
  ...
  return (
    ...
    >
      ...
      <div className="mx-4 my-20 z-10">
        {/* ml-[650px] z-10 */}
        <h1 className="font-main pt-10 lg:pt-0 text-2xl text-hippie-blue-400 mb-5">
          {t("About.title")}
        </h1>
        <div className="flex lg:flex-row-reverse">
          ...
          {/* Image */}
          <img
            className="hidden xl:ml-10 p-8 md:p-2 sm:block sm:w-44 lg:w-72 xl:w-96 sm:h-[11.5rem] lg:h-auto sm:mt-10 md:-mt-2 sm:rounded-2xl sm:object-cover" /* absolute -top-20 -right-0 -z-10  */
            src={image}
            width={550}
            alt="Test 2"
          />
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-0 mx-10 font-secondary text-xl md:text-[1.3rem] xl:text-[1.42rem] font-medium mt-2">
          {techs.map((tech) => {
            return (
