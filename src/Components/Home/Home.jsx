...
import image from "../../img/tower.png";
...
const Home = () => {
  ...
  return (
    <div
      className="relative pt-14 lg:pt-[4.5rem] mx-5 md:ml-12 lg:mx-14 lg:ml-[4.5rem] mt-0 mb-20 z-10"
    >
      ...
      <div className="mt-4 font-main text-2xl text-hippie-blue-400 tracking-wide h-28 sm:h-14 md:h-6">
        <TypeAnimation
          key={t("Home.job.key")}
          sequence={[
      ...
      {/* Image */}
      <img
        className="absolute p-2 -z-10 top-80 bty:top-56 md:top-5 lg:-top-10 2xl:-top-28 right-0 sm:right-1 lg:right-3 xl:right-6 2xl:right-28 w-72 lg:w-80 xl:w-[22rem] 2xl:w-96 rounded-2xl object-cover"
        src={image}
        alt="Test 1"
      />
    </div>
